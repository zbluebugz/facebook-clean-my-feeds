(function () {
    ...
    if (elementsSVGText.length > 0) {
        ...
        if (arWidths.length > 0) {
            ...
            // - filter for uBO:
            const filterComment1 = '! FB - sponsored text (November 2022) *** IN TEST MODE - highlights post that met a certain criteria ***\n';
            const filterComment2 = '! FB - sponsored text (November 2022)\n';
