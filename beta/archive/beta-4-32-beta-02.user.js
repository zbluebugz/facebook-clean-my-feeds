...
/*
    ...
    v4.32.beta-02 :: September
        Updated Follow detection rules
        Updated the aggressiveness

    v4.31.hf :: July 2024
        Reels and Short Videos - Português (Portugese) spelling correction (for Brazil)
...
(async function () {
    ...
    const VARS = {
        ...
        scanCountMaxLoop: 21, // Sept 2024; changed from 15 to 21, need to make code a tad bit more aggressive.
