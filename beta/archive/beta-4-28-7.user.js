...
(async function () {
    ...
    function mopUpTheReelFeed() {
        ...
        // console.info(log+'mopUpTheReelFeed(); videos:', videos);
            ...
            if (elVideoId) {
                ...
                if (videoContainer) {
                    ...
                    if (descriptionOverlay) {
                        ...
                        elDescriptionContainer.setAttribute('style', 'margin-bottom:2rem;');
