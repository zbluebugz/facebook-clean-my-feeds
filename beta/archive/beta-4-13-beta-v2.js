// ==UserScript==
// @name         FB - Clean my feeds (v4.13-beta-v2)
...
// ==/UserScript==
/*
    v4.13-beta-v2 :: December 2022
        News Feed blocked text filter - allow Regular Expressions
        Groups Feed blocked text filter - allow Regular Expressions
    v4.13-beta :: December 2022
...
(async function () {
    ...
    function nf_isBlockedText(post) {
        ...
        for (let b = 0; b < btL; b++) {
            ...
            let regFind = new RegExp(VARS.Filters.NF_BLOCKED_TEXT_LC[b], 'i') // do not use 'g' - want to reset lastindex to 0 for each test.
            if (regFind.test(ptexts)) {
    ...
    function gf_isBlockedText(post) {
        ...
        for (let b = 0; b < btL; b++) {
            ...
            let regFind = new RegExp(VARS.Filters.GF_BLOCKED_TEXT_LC[b], 'i') // do not use 'g' - want to reset lastindex to 0 for each test.
            if (regFind.test(ptexts)) {
                // before breaking out, get the text that matched.
