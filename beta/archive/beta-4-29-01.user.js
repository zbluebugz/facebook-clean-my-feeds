// ==UserScript==
// @name         FB - Clean my feeds (4.29.beta-01)
...
/*
    ...
    v4.29 - beta 01 :: February 2024
        Hot fix !!!
        FB's code has changed - causing some weird behaviours
        - News feed is causing error : "An error occurred. It may be due a technical error that we were trying to solve ..."
        - Adjusted news feed's query rules
        - Disable message/notification tab
...
(async function () {
    ...
    const SCRIPT_VERSION = 'v4.29 beta 01'; // TM doesn't like spaces in version number ...
