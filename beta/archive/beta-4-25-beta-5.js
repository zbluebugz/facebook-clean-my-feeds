...
// ==/UserScript==
/*
    v4.25 :: BETA :: October / November 2023
        Added News Feed's Stories post detection rule.
        Revised function scanTreeForText() to include other elements for scanning
        Reduce possible conflicts with uBlock Origin / other content/ad blockers
        Added extra filter rule for nf_isSuggested() (for "Suggested for you" posts) - fix supplied by opello
        Code tweaks
